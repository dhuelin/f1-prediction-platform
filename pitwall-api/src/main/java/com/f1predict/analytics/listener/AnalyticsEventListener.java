...
public class AnalyticsEventListener {
    ...
    // In-process events — prediction and scoring share this process now
    @EventListener
    ...
    @RabbitListener(queues = RabbitMQConfig.ANALYTICS_RACE_RESULT_QUEUE)
    ...
    @RabbitListener(queues = RabbitMQConfig.ANALYTICS_SESSION_COMPLETE_QUEUE)
